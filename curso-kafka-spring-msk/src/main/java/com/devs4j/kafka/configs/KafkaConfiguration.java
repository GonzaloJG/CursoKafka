...
public class KafkaConfiguration {
    ...
    private Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"localhost:9092"); //Sustituir por la de AWS
    ...
    private Map<String, Object> producerProps() {
        Map<String, Object> props=new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,"localhost:9092"); //Sustituir por la de AWS
